...
echo "<p><h2>".$arrayp['prodDescripShort']."</h2><br>"; //display product short discription as contained in the array
echo "<p><h2><b>".$arrayp['prodPrice']."</b></h2>"; //display product name as contained in the array
echo "</td>";
echo "</tr>";
}
echo "</table>";
